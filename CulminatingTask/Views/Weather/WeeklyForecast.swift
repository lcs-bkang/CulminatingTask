...
//
//    // Variable to hold the high temperature of day 1
//    @State var highTemp1: Double = 0.0
//
//    // Variable to hold the high temperature of day 2
//    @State var highTemp2: Double = 0.0
//
//    // Variable to hold the high temperature of day 3
//    @State var highTemp3: Double = 0.0
//
//    // Variable to hold the high temperature of day 4
//    @State var highTemp4: Double = 0.0
//
//    // Variable to hold the high temperature of day 5
//    @State var highTemp5: Double = 0.0
//
//    // Variable to hold the high temperature of day 6
//    @State var highTemp6: Double = 0.0
//
//    // Variable to hold the high temperature of day 7
//    @State var highTemp7: Double = 0.0
//
//    // Variable to hold the low temperature of day 1
//    @State var lowTemp1: Double = 0.0
//
//    // Variable to hold the low temperature of day 2
//    @State var lowTemp2: Double = 0.0
//
//    // Variable to hold the low temperature of day 3
//    @State var lowTemp3: Double = 0.0
//
//    // Variable to hold the low temperature of day 4
//    @State var lowTemp4: Double = 0.0
//
//    // Variable to hold the low temperature of day 5
//    @State var lowTemp5: Double = 0.0
//
//    // Variable to hold the low temperature of day 6
//    @State var lowTemp6: Double = 0.0
//
//    // Variable to hold the low temperature of day 7
//    @State var lowTemp7: Double = 0.0
//
//    // Variable to hold the chance of precipitation of day 1
